...
img_dir = '/data/steven/project/Object_Detection_coastal/dataser_raw/1_rutouying/images_raw_anno/orginal_img_multi_crop_{}/'.format(try_time)
train_json = '/data/steven/project/Object_Detection_coastal/dataser_raw/1_rutouying/COCOjson/train_val/{}_train.json'.format(try_time)
val_json = '/data/steven/project/Object_Detection_coastal/dataser_raw/1_rutouying/COCOjson/train_val/{}_val.json'.format(try_time)

out_dir = root_dir+'output/0_RTY/'+dataset_type+'_'+try_time+'/'+model_name
