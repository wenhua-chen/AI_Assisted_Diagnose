...
# import os
dataset_type = 'XGB_dataset'
model_name = 'cascade_rcnn_dconv_c3_c5_r50_fpn_1x_num_libra_alub'

try_time = 'XGBGH_0820_2900_2stage_T0a_Alltrain'

root_dir = '/data/steven/project/Object_Detection_coastal/mmdetection_project/'
img_dir = '/data/steven/project/Object_Detection_coastal/dataser_raw/4_xueguanbigaihua/images_raw_anno/{}/'.format(try_time)
train_json = '/data/steven/project/Object_Detection_coastal/dataser_raw/4_xueguanbigaihua/COCOjson/train_val/{}_train.json'.format(try_time)
val_json = '/data/steven/project/Object_Detection_coastal/dataser_raw/4_xueguanbigaihua/COCOjson/train_val/{}_val.json'.format(try_time)

# out_dir = root_dir+'output/3_XGBGH/'+dataset_type+'_'+try_time+'/'+model_name
