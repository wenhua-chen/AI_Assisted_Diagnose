...
def find_HengGe_diff(mask_dict,orinal_path,img_out=None,draw=True):
    ...
    if end_pt_fei0 > end_pt_fei1 and fei0_dire == 'left':
        re_dire = 'right'
    elif end_pt_fei0 > end_pt_fei1 and fei0_dire == 'right':
        re_dire = 'left'
    elif end_pt_fei1 > end_pt_fei0 and fei1_dire == 'left':
        re_dire = 'right'
    elif end_pt_fei1 > end_pt_fei0 and fei1_dire == 'right':
        re_dire = 'left'
    # if img_out:
    ...
    if img_out:
        draw_pt(in_path=orinal_path,pt=end_pt_fei0,out_path=img_out,color=(138,0,255))
        draw_pt(in_path=img_out,pt=end_pt_fei1,out_path=img_out,color=(42,141,255))
        draw_line(in_path=img_out,pt1=end_pt_fei0,pt2=end_pt_fei1,distance=diff2line,out_path=img_out,color=(138,0,255))
    if end_pt_fei0[0] > end_pt_fei1[0]:
        return [diff2line,re_dire,end_pt_fei1,end_pt_fei0]
    else:
        return [diff2line,re_dire,end_pt_fei0,end_pt_fei1]
