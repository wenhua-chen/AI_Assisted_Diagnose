...
if __name__ == '__main__':
    ...
    if single_test:
        ...
        # pts_list = [[468, 112, 1403, 2014],[1516, 151, 2269, 2070],[953, 945, 1269, 1477],[1594, 853, 1895, 1302]]
        pts_list = [[10, 10, 2269, 2269],[10, 10, 2269, 2269],[953, 945, 1269, 1477],[1594, 853, 1895, 1302]]

        start = timer()
        boxesr, clses = pred_lungsplit(model,im_name,pts_list)
        # boxesr, clses = pred_lungtogether(model,im_name,pts_list)
