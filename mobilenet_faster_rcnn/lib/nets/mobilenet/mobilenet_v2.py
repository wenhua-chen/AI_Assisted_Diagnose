...
V2_DEF = dict(
    ...
    spec=[
        op(slim.conv2d, stride=2, num_outputs=32, kernel_size=[3, 3], scope="Conv"),
        ...
        # modify stride from 2 to 1
        op(ops.expanded_conv, stride=1, num_outputs=160, scope="expanded_conv_13"),
