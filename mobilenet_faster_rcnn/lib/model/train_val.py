...
class SolverWrapper(object):
  ...
  def train_model(self, sess, max_iters):
    ...
    while iter < max_iters + 1:
      ...
      #   cv2.rectangle(blobs['data'][0], (bbox[0], bbox[1]), (bbox[2], bbox[3]), (255,0,0),2)
      # cv2.imwrite('/home/lyc/tf-faster-rcnn/images_test/checking_{}.jpg'.format(ran_num), blobs['data'][0])
