...
# Number of fixed layers during training, by default the bottom 5 of 18 layers is fixed
# Range: 0 (none) to 17 (all)
__C.MOBILENET.FIXED_LAYERS = 5
__C.MOBILENET.FIXED_LAYERS_2 = 5
...
# for mobilenet v2
__C.MOBILENET.DEPTH_MULTIPLIER_2 = 1.0
